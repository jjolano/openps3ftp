...
#ifdef OPFTP_PS3
/* Stock PSL1GHT netinet/in.h is IPv4-only; the expanded ps3dk stage
 * adds IPv6 types. Provide them here so both toolchains build.
 * INET6_ADDRSTRLEN is only defined by an IPv6-capable SDK header. */
