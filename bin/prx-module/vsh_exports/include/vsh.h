...
extern void vsh_F4AD1B8A(int32_t arg, vsh_vm_info *info);  // get virtual memory info
...
extern int32_t vsh_E7C34044(int32_t mc_id);	             // vsh_memory_container_by_id()
#define vsh_memory_container_by_id vsh_E7C34044

extern int32_t vsh_F399CA36(int32_t mc_id);              // destroy_vsh_memory_container_by_id()
